...
public enum Direction {
    ...
    public static Coordinate northVector = new Coordinate(0,-1);
    public static Coordinate southVector = new Coordinate(0,1);
    public static Coordinate westVector = new Coordinate(-1,0);
    public static Coordinate eastVector = new Coordinate(1,0);
    public static EnumMap<Direction, Coordinate> dirToCoordinateDeltaMap = buildDirToCoordinateDelta();
