...
public class TSPData implements Serializable {
     ...
     * @param maze
     */
    public void calculateRoutes(AntColonyOptimization aco) throws Exception {
     ...
     */
    private Route[][] buildDistanceMatrix(AntColonyOptimization aco) throws Exception {
     ...
     */
    private Route[] buildStartToProducts(AntColonyOptimization aco) throws Exception {
     ...
     */
    private Route[] buildProductsToEnd(AntColonyOptimization aco) throws Exception {
